<header class="header shop">
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        <?php
                            $settings=DB::table('settings')->get();
                        ?>                    
                        <a href="<?php echo e(route('home')); ?>"><img src="<?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($data->logo); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" alt="#" style="max-width:100px;height:auto;"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                    ...
                                    <ul class="shopping-list">
                                            ...
                                            <?php $__currentLoopData = Helper::getAllProductFromWishlist(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="<?php echo e(route('product-detail',$data->product['slug'])); ?>"><img src="<?php echo e($photo[0]); ?>" alt="<?php echo e($data->product['title']); ?>"></a>
                                                        <h4><a href="<?php echo e(route('product-detail',$data->product['slug'])); ?>" target="_blank"><?php echo e($data->product['title']); ?></a></h4>
                                                        <p class="quantity"><?php echo e($data->quantity); ?> x - <span class="amount"><?php echo e(Helper::formatCurrency($data->price)); ?></span></p>
                                                    </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount"><?php echo e(Helper::formatCurrency(Helper::totalWishlistPrice())); ?></span>
                                        </div>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount"><?php echo e(Helper::formatCurrency(Helper::totalCartPrice())); ?></span>
                                        </div>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="<?php if(Request::path()=='product-grids'||Request::path()=='product-lists'): ?>  active  <?php endif; ?>"><a href="<?php echo e(route('product-grids')); ?>">Products</a></li>												
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH D:\Intern-Job\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>