...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <?php if($logoDataUri): ?>
        <img src="<?php echo e($logoDataUri); ?>" alt="">
      <?php endif; ?>
    </div>
    <div class="float-right site-address">
      ...
      <?php endif; ?>
      <?php if($companyPhone !== ''): ?>
        <p>Phone: <a href="tel:<?php echo e($companyPhone); ?>"><?php echo e($companyPhone); ?></a></p>
      <?php endif; ?>
      <?php if($companyEmail !== ''): ?>
        <p>Email: <a href="mailto:<?php echo e($companyEmail); ?>"><?php echo e($companyEmail); ?></a></p>
      <?php endif; ?>
    </div>
  ...
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      ...
      <?php $__currentLoopData = $order->cart_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          <td><span>
              <?php echo e(optional($cart->product)->title); ?>
      ...
      <tfoot>
        ...
        <tr>
          ...
          <th><span>$<?php echo e(number_format(optional($order->shipping)->price ?? 0,2)); ?></span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
...
</html><?php /**PATH D:\Intern-Job\Complete-Ecommerce-in-laravel-10-master\resources\views/backend/order/pdf.blade.php ENDPATH**/ ?>