<?php $__env->startSection('title','DL || HOME PAGE'); ?>
                        ...
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group product-filter-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="filter-btn" data-filter=".<?php echo e($cat->id); ?>"><?php echo e($cat->title); ?></button>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </ul>
                                    ...
                                    <div class="single-product" data-product-url="<?php echo e(route('product-detail',$product->slug)); ?>">
                                        <div class="product-img">
                                            <a href="<?php echo e(route('product-detail',$product->slug)); ?>">
                                                ...
                                                ?>
                                                <img class="default-img" src="<?php echo e($firstPhoto); ?>" alt="<?php echo e($product->title); ?>">
                                                <img class="hover-img" src="<?php echo e($firstPhoto); ?>" alt="<?php echo e($product->title); ?>">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $latest_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                            <!-- Start Single List  -->
                            <div class="single-list" data-product-url="<?php echo e(route('product-detail',$product->slug)); ?>">
                                <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <?php
                                            $after_discount=($product->price-($product->price*$product->discount)/100);
                                        ?>
                                        <p class="price with-discount"><?php echo e(Helper::formatCurrency($after_discount)); ?></p>
                                    </div>
                                </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern-Job\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/index.blade.php ENDPATH**/ ?>