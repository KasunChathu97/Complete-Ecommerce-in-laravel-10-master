<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  ?>
    ...
    <li class="nav-item">
        ...
        <div id="reportCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(route('reports.product-sales')); ?>">Product Sales</a>
            <a class="collapse-item" href="<?php echo e(route('reports.sales-summary')); ?>">Sales Summary</a>
          </div>
        </div>
    </li>
    ...
    <!-- SMS Logs -->
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('sms-logs.index')); ?>">
...
</ul><?php /**PATH D:\Intern-Job\Complete-Ecommerce-in-laravel-10-master\resources\views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>