								...
								<?php if(Helper::getAllProductFromCart()): ?>
									<?php $__currentLoopData = Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											?>
											<td class="image" data-title="No"><img src="<?php echo e($photo[0]); ?>" alt="<?php echo e($cart->product['title']); ?>"></td>
											...
											<td class="price" data-title="Price"><span><?php echo e(Helper::formatCurrency($cart['price'])); ?></span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money"><?php echo e(Helper::formatCurrency($cart['amount'])); ?></span></td>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="<?php echo e(Helper::totalCartPrice()); ?>">Cart Subtotal<span><?php echo e(Helper::formatCurrency(Helper::totalCartPrice())); ?></span></li>

										<?php if(session()->has('coupon')): ?>
										<li class="coupon_price" data-price="<?php echo e(Session::get('coupon')['value']); ?>">You Save<span><?php echo e(Helper::formatCurrency(Session::get('coupon')['value'])); ?></span></li>
										<?php endif; ?>
										<?php
										...
										?>
										<?php if(session()->has('coupon')): ?>
											<li class="last" id="order_total_price">You Pay<span><?php echo e(Helper::formatCurrency($total_amount)); ?></span></li>
										<?php else: ?>
											<li class="last" id="order_total_price">You Pay<span><?php echo e(Helper::formatCurrency($total_amount)); ?></span></li>
										<?php endif; ?>
									</ul>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<i class="ti-rocket"></i>
						<h4>Free shiping</h4>
						<p>Orders over <?php echo e(Helper::formatCurrency(100)); ?></p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
	...
	<script>
		$(document).ready(function(){
			$('.shipping select[name=shipping]').change(function(){
				...
				// alert(coupon);
				$('#order_total_price span').text('<?php echo e(Helper::currencySymbol()); ?> '+(subtotal + cost-coupon).toFixed(2));
			});
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern-Job\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>