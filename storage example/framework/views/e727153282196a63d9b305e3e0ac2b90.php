<?php $__env->startSection('title','DL || PRODUCT PAGE'); ?>
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="<?php echo e(route('product-grids')); ?>">Products</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                ?>
                                                <p class="price"><del class="text-muted"><?php echo e(Helper::formatCurrency($product->price)); ?></del>   <?php echo e(Helper::formatCurrency($org)); ?>  </p>
                            ...
                            <?php if(count($products)>0): ?>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product" data-product-url="<?php echo e(route('product-detail',$product->slug)); ?>">
                                            <div class="product-img">
                                                <a href="<?php echo e(route('product-detail',$product->slug)); ?>">
                                                    <?php
                                                        $photo=explode(',',$product->photo);
                                                    ?>
                                                    <img class="default-img" src="<?php echo e($photo[0]); ?>" alt="<?php echo e($product->title); ?>">
                                                    <img class="hover-img" src="<?php echo e($photo[0]); ?>" alt="<?php echo e($product->title); ?>">
                                            ...
                                            <div class="product-content">
                                                ...
                                                ?>
                                                <span><?php echo e(Helper::formatCurrency($after_discount)); ?></span>
                                                <?php if($product->discount>0): ?>
                                                    <del style="padding-left:4%;"><?php echo e(Helper::formatCurrency($product->price)); ?></del>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="pagination-wrapper">
                                    <div class="pagination-info">
                                        <p>Showing <?php echo e(($products->currentPage()-1)*$products->perPage()+1); ?> to <?php echo e(min($products->currentPage()*$products->perPage(), $products->total())); ?> of <?php echo e($products->total()); ?> entries</p>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="quickview-content">
                                            ...
                                            <?php
                                                $after_discount=($product->price-($product->price*$product->discount)/100);
                                            ?>
                                            <h3><small><del class="text-muted"><?php echo e(Helper::formatCurrency($product->price)); ?></del></small>    <?php echo e(Helper::formatCurrency($after_discount)); ?>  </h3>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern-Job\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/product-grids.blade.php ENDPATH**/ ?>