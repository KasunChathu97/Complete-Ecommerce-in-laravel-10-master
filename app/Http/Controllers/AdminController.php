...
class AdminController extends Controller
{
    ...
    public function settings(){
        $data=Settings::first() ?? new Settings();
    ...
    public function settingsUpdate(Request $request){
        ...
        $this->validate($request,[
            ...
            'commitment_energy_independence'=>'nullable|string',
            'specialized_product_range'=>'nullable|string',
            'why_choose_delimach_lanka'=>'nullable|string',
            'photo'=>'required',
            'logo'=>'required',
