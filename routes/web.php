...
// Backend section start
    ...
    Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'role:admin,staff,salesman']], function () {
        ...
        Route::delete('/order/tracking/{tracking}', 'ShipmentTrackingController@destroy')->name('order.tracking.destroy');

        // SMS Logs (read-only)
        Route::get('/sms-logs', 'SmsLogController@index')->name('sms-logs.index');

        // Reports
        Route::get('/reports/product-sales', [ReportController::class, 'productSales'])->name('reports.product-sales');
        Route::get('/reports/product-sales/export/pdf', [ReportController::class, 'productSalesPdf'])->name('reports.product-sales.pdf');
        Route::get('/reports/product-sales/export/excel', [ReportController::class, 'productSalesExcel'])->name('reports.product-sales.excel');

        Route::get('/reports/sales-summary', [ReportController::class, 'salesSummary'])->name('reports.sales-summary');
        Route::get('/reports/sales-summary/export/pdf', [ReportController::class, 'salesSummaryPdf'])->name('reports.sales-summary.pdf');
        Route::get('/reports/sales-summary/export/excel', [ReportController::class, 'salesSummaryExcel'])->name('reports.sales-summary.excel');
    });
...
// User section start
    Route::group(['prefix' => '/user', 'middleware' => ['user']], function () {
        ...
        // SMS Logs (only for the logged-in user's orders)
        Route::get('/sms-logs', "HomeController@smsLogIndex")->name('user.sms-logs.index');

        // Notifications (for the logged-in user)
        Route::get('/notification/{id}', [NotificationController::class, 'show'])->name('user.notification');
        Route::get('/notifications', [HomeController::class, 'notificationsIndex'])->name('user.notifications');
        // Product Review
