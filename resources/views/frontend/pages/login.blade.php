                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="login" placeholder="Enter email or phone number" required="required" value="{{ old('login') }}">
                                        @error('login')
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        <button class="btn btn-login" type="submit">Login</button><br><br>
                                         <span>Don't have an account? </span>
                                         <a href="{{route('register.form')}}" class="signup-now-link" style="color:#073088;font-weight:600;text-decoration:underline;cursor:pointer;">Sign up</a>
                                        <!--OR
