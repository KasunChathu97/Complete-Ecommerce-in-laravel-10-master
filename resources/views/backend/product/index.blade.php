                    ...
                    <td>
                        @if($product->photo)
                            @php
                              ...
                              // dd($photo);
                            @endphp
                            <img src="{{$photo[0]}}" class="img-fluid zoom product-thumb" alt="{{$product->title}}">
                        @else
                            <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid product-thumb" alt="thumbnail">
                        @endif
                    </td>
                    <td>
