    ...
    <div class="card-body">
      ...
      @if($errors->any() && !session('error'))
        <div class="alert alert-danger alert-dismissable fade show">
            ...
            Product not added. Please check the form and try again.
        </div>
      @endif
      <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="see_more_description" name="see_more_description">{{old('see_more_description')}}</textarea>
        ...
        <div class="form-group">
          <label for="free_shipping">Enable Free Shipping</label><br>
          <input type="checkbox" name='free_shipping' id='free_shipping' value='1' {{ old('free_shipping') ? 'checked' : '' }}> Yes
        </div>
              {{-- {{$categories}} --}}
        ...
        <div class="form-group">
          ...
          <select name="cat_id" id="cat_id" class="form-control">
              ...
              @foreach($categories as $key=>$cat_data)
                  <option value='{{$cat_data->id}}' {{ (string)old('cat_id') === (string)$cat_data->id ? 'selected' : '' }}>{{$cat_data->title}}</option>
              @endforeach
          </select>
          @error('cat_id')
          <span class="text-danger">{{$message}}</span>
        ...
        <div class="form-group">
          ...
          <input id="sale_price" type="number" step="0.01" name="sale_price" placeholder="Enter sale price" value="{{ old('sale_price', old('price')) }}" class="form-control">
          @error('sale_price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          <label for="stock">Main Stock <span class="text-danger">*</span></label>
