    ...
    <div class="card-body">
      ...
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='1' {{ old('is_featured', (bool)($product->is_featured ?? false)) ? 'checked' : '' }}> Yes
        </div>
        <div class="form-group">
          <label for="free_shipping">Enable Free Shipping</label><br>
          <input type="checkbox" name='free_shipping' id='free_shipping' value='1' {{ old('free_shipping', (bool)(($product->free_shipping ?? false) || ($product->free_shipping_enabled ?? false))) ? 'checked' : '' }}> Yes
        </div>
              {{-- {{$categories}} --}}
