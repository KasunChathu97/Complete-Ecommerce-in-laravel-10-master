...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Sales Admins</h6>
      <a href="{{route('sales-admins.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Sales Admin"><i class="fas fa-plus"></i> Add Sales Admin</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered" id="sales-admin-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>S.N.</th>
              <th>Name</th>
        ...
        <span style="float:right">{{$salesAdmins->links()}}</span>
      </div>
    </div>
</div>
@endsection
...
@push('scripts')
  ...
  <script>
      $('#sales-admin-dataTable').DataTable( {
            "columnDefs":[
                {
                    "orderable":false,
                    "targets":[5,6]
