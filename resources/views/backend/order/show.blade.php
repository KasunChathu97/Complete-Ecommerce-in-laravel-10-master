        ...
        <div class="row">
          ...
          <div class="col-lg-12 mt-4">
            <div class="shipping-info">
              ...
              <form method="POST" action="{{ route('order.tracking.store', $order->id) }}" class="mb-3">
                @csrf
                <div class="form-row">
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    @forelse($order->shipmentTrackings()->orderBy('event_time','desc')->orderBy('id','desc')->get() as $tracking)
                      <tr>
                        ...
                        <td>
                          <form method="POST" action="{{ route('order.tracking.destroy', $tracking->id) }}">
                            @csrf
                            @method('delete')
