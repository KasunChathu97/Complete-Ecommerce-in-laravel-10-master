                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          <span class="input-group-btn">
                                                            <button id="photoPickerBtn" type="button" class="btn btn-primary">
                                                            <i class="fa fa-picture-o"></i> Choose
                                                            </button>
                          </span>
                          <input id="thumbnail" class="form-control" type="text" name="photo" value="{{$profile->photo}}">
                      </div>
                                            <input id="photo_file" type="file" name="photo_file" class="d-none" accept="image/*">
                        @error('photo')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                                                @error('photo_file')
...
@push('scripts')
<script>
    $('#photoPickerBtn').on('click', function () {
